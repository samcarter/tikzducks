...
\textcolor{red!60!black}{Note for \lstinline|XeLaTeX|:} Due to technical limitations, the random seed is fixed for xelatex, this means that  \lstinline|\randuck| will still print another duck on each call, however the sequence is always the same. 
