...
The various parts of the duck body can also be coloured independently, i.e. \verb|body|, \verb|head| and \verb|bill|:
...
Some examples how the \verb|tikzducks| can be customised:
