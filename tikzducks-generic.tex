...
\def\duck@listhead{}
\def\duck@listacces{}
\def\duck@headtext{head}
\def\duck@accesstext{acess}

\ExplSyntaxOn
\NewDocumentCommand{\duck@ini}{om}{
  \expandafter\newif\csname ifduck@#2\endcsname
  \def\duck@tmp{#1}
  \ifx\duck@headtext\duck@tmp
    \tl_put_right:Nn \duck@listhead { {#2} }
  \fi
  \ifx\duck@accesstext\duck@tmp
    \tl_put_right:Nn \duck@listacces { {#2} }
  \fi  
}
\ExplSyntaxOff
...
\duck@ini[acess]{cape}
\duck@ini{stripes}
\duck@ini[acess]{bowtie}
\duck@ini{lapel}
\duck@ini{aodai}
\duck@ini[acess]{scarf}
% Headgear %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\duck@ini[head]{alien}
\duck@ini[head]{hat}
\duck@ini[head]{cap}
...
% Accessories %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\duck@ini[acess]{glasses}
\duck@ini[acess]{sunglasses}
\duck@ini[acess]{squareglasses}
\duck@ini[acess]{icecream}
\duck@ini[acess]{book}
\duck@ini[acess]{magicwand}
\duck@ini[acess]{cricket}
\duck@ini[acess]{rollingpin}
\duck@ini[acess]{signpost}
\duck@ini[acess]{lightsaber}
\duck@ini[acess]{cake}
\duck@ini[acess]{pizza}
\duck@ini[acess]{hockey}
\duck@ini[acess]{baguette}
\duck@ini[acess]{football}
\duck@ini[acess]{mask}
\duck@ini[acess]{necklace}
\duck@ini[acess]{milkshake}
\duck@ini[acess]{wine}
\duck@ini[acess]{prison}
\duck@ini{speech}
\duck@ini{think}
\duck@ini[acess]{torch}
\duck@ini[acess]{easter}
\duck@ini[acess]{basket}
\duck@ini{buttons}
\duck@ini{sheep}
\duck@ini{horsetail}
\duck@ini[acess]{crozier}
\duck@ini{davidlikespineapplepizza}
\duck@ini{wing}
\duck@ini[acess]{stethoscope}
\duck@ini[acess]{neckerchief}
\duck@ini{snowduck}
\duck@ini{vampire}
\duck@ini[acess]{crystalball}
\duck@ini[acess]{cheese}
\duck@ini[acess]{shovel}
\duck@ini[acess]{pickaxe}
\duck@ini[acess]{strawbroom}
\duck@ini[acess]{broom}
\duck@ini[acess]{umbrella}
\duck@ini[acess]{umbrellaclosed}
\duck@ini[acess]{handbag}
\duck@ini[acess]{cocktail}
\duck@ini{overleaf}
\duck@ini[acess]{banana}
\duck@ini[acess]{stick}
\duck@ini{megaphone}
