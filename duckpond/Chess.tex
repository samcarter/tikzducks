...
% Springer %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\springer}[1]{%
	\begin{tikzpicture}
		\begin{pgfinterruptboundingbox}
			\begin{scope}[yshift=-6]
				\clip[rotate=-5] (0.68,2.38) ellipse (0.3 and 0.4);
				\fill[#1,rotate=-5](0.28,2.26)ellipse (0.3 and 0.4);
			\end{scope}
		\end{pgfinterruptboundingbox}
		\duck[body=#1,bill=accent,horsetail,mohican=accent]
		\begin{pgfinterruptboundingbox}
			\begin{scope}[yshift=-5,xshift=1]
				\clip[rotate=-5] (0.68,2.38) ellipse (0.3 and 0.4);
				\fill[#1,rotate=-5](1.06,2.2) ellipse (0.3 and 0.4);
			\end{scope}
		\end{pgfinterruptboundingbox}
		\ifcutlines
			\draw[cutline] (1.,0.1) -- (1.,0.5);
...
\newcommand{\laeufer}[1]{%
	\begin{tikzpicture}
		\duck[body=#1,bill=accent,crozier=accent]
		% mita
...
\newcommand{\dame}[1]{%
	\begin{tikzpicture}
		\duck[body=#1,necklace=gray,longhair=accent,bill=accent]
		\begin{scope}[yshift=2]
			\fill[#1] \duckpathqueencrown;
		\end{scope}
		\ifcutlines
			\draw[cutline] (1.,0.1) -- (1.,0.5);
		\fi	
...
\newcommand{\koenig}[1]{%
	\begin{tikzpicture}
		\duck[body=#1,shorthair=accent,bill=accent]
		\begin{scope}[yshift=4]
			\fill[#1] \duckpathkingcrown;
		\end{scope}
		\ifcutlines
			\draw[cutline] (1.,0.1) -- (1.,0.5);
		\fi	
...
\begin{tabular}{cccccccc}
	\turm{dark} & \springer{dark} & \laeufer{dark} & \dame{dark} & \koenig{dark} & \laeufer{dark} & \springer{dark} & \turm{dark}\\
	\bauer{dark} & \bauer{dark} & \bauer{dark} & \bauer{dark} & \bauer{dark} & \bauer{dark} & \bauer{dark} & \bauer{dark}\\[1cm]
	\bauer{light} & \bauer{light} & \bauer{light} & \bauer{light} & \bauer{light} & \bauer{light} & \bauer{light} & \bauer{light}\\
	\turm{light} & \springer{light} & \laeufer{light} & \dame{light} & \koenig{light} & \laeufer{light} & \springer{light} & \turm{light}\\
\ifcutlines	
