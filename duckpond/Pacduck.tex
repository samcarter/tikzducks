% !TeX TS-program = pdflatex "\AtBeginDocument{\pagecolor{gray!20!white}}\input{%}" % | /usr/bin/sips -s format png %.pdf --out %.png | pdflatex % | convert -delay 10 -loop 0 -density 100 -alpha remove %.pdf %.gif | txs:///view-log | txs:///view-pdf
