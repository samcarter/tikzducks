% !TeX TS-program = pdflatex "\AtBeginDocument{\pagecolor{gray!20!white}}\input{%}" % | pdftoppm -png -r 240 -singlefile %.pdf % | pdflatex % | convert -delay 10 -loop 0 -density 100 -alpha remove %.pdf %.gif | txs:///view-log | txs:///view-pdf
